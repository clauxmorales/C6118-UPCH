...
```{r echo=FALSE, fig.width=12, fig.height=10, fig.cap="**Figura 4: Producción vegetal integral (fitoplancton grande) en el a)promedio período 1959-2004, anomalía de b)mi primer año de vida (1978-1979), c)período 1982-1983 y b) períodeo 1997-1998**"}
library(ncdf4)
library(fields)
library(kali)
